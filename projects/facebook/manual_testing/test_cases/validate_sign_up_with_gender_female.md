# Test Case: Validate Sign Up With Gender Female
...
**Expected Result:**   
- The system accepts the provided gender Female
...
- No additional fields should appear when Female is selected
